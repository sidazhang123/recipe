package me.sidazhang.recipe.controllers.v1;

import com.fasterxml.jackson.databind.ObjectMapper;
import me.sidazhang.recipe.api.v1.DTO.CustomerDTO;
import me.sidazhang.recipe.controllers.api.v1.CustomerController;
...
public class CustomerControllerTest {
    ...
    public void createNewCustomer() throws Exception {
        ...
        mockMvc.perform(post("/api/v1/customer/")
                ...
                .andExpect(jsonPath("$.url", equalTo("/api/v1/customer/1")));
    }
